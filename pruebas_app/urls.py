...
urlpatterns = [
    ...
    path('aplicaciones/<int:aplicacion_id>/versiones/<int:version_id>/', views.eliminar_version, name='eliminar_version'),
    ...
    path('estrategias/<int:estrategia_id>/condiciones/', views.condiciones_de_lanzamiento,name='condiciones_de_lanzamiento'),
    path('estrategias/<int:estrategia_id>/', views.detalle_estrategia, name='detalle_estrategia'),
    path('estrategias/<int:estrategia_id>/copia/', views.copiar_estrategia, name='copiar_estrategia'),
